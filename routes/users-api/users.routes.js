...
exports.addAPIRouter = function(app, UserCtrl){ //Siempre hay que utilizar el export cuando queremos registrar una funcion
	...
	users.route('/users/:email') //la variable 'req', trae como 'params' una variable llamada 'matricula'
		.get(UserCtrl.findByMatricula);
	users.route('/users/:email/:password') //la variable 'req', trae como 'params' una variable llamada 'matricula' y otra llamada 'password'
